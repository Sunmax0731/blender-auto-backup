...
- Issue 0009 is an exact duplicate of Issue 0008.
- The retained triage evidence is `docs/backlog-triage.md`.
- No separate implementation, test, or release work remains for this duplicate issue.

## Evidence

- Resolved through duplicate consolidation into Issue 0008.
- `TODO.md` links this issue as completed and notes the consolidation.
- `docs/backlog-triage.md` records the duplicate and granularity review.
